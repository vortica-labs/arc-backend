...
router.get("/dashboard", auditLog("VIEW_BROADCAST_DASHBOARD"), requireAdminPermission("broadcasts:read"), durableMutationAudit("VIEW_BROADCAST_DASHBOARD"), controller.getDashboard);
router.get("/delivery-logs", auditLog("VIEW_BROADCAST_DELIVERY_LOGS"), requireAdminPermission("broadcasts:read"), durableMutationAudit("VIEW_BROADCAST_DELIVERY_LOGS"), controller.getDeliveryLogs);
router.post("/preview", auditLog("PREVIEW_BROADCAST_PAYLOAD"), requireAdminPermission("broadcasts:read"), durableMutationAudit("PREVIEW_BROADCAST_PAYLOAD"), controller.previewPayload);
router.get("/", auditLog("VIEW_BROADCASTS"), requireAdminPermission("broadcasts:read"), durableMutationAudit("VIEW_BROADCASTS"), controller.listBroadcasts);
...
router.get("/:id", auditLog("VIEW_BROADCAST"), requireAdminPermission("broadcasts:read"), durableMutationAudit("VIEW_BROADCAST"), controller.getBroadcast);
...
router.post("/:id/preview", auditLog("PREVIEW_BROADCAST"), requireAdminPermission("broadcasts:read"), durableMutationAudit("PREVIEW_BROADCAST"), controller.previewBroadcast);
...
router.get("/:id/analytics", auditLog("VIEW_BROADCAST_ANALYTICS"), requireAdminPermission("broadcasts:read"), durableMutationAudit("VIEW_BROADCAST_ANALYTICS"), controller.getAnalytics);
router.get("/:id/recipients", auditLog("VIEW_BROADCAST_RECIPIENTS"), requireAdminPermission("broadcasts:read"), durableMutationAudit("VIEW_BROADCAST_RECIPIENTS"), controller.getRecipients);
